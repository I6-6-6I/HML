...
HEADER_MATH_NAMESPACE
{
	...
	#pragma region CONSTRUCTORS
		...
		constexpr matrix(T const& x1, T const& y1, T const& z1, T const& x2, T const& y2, T const& z2, T const& x3, T const& y3, T const& z3)
		{
	...
	#pragma region CONVERSIONS
		template<typename U, typename V, typename M, typename N, typename P, typename D, typename S, typename L, typename Z>
		constexpr matrix(U const& x1, V const& y1, M const& z1, N const& x2, P const& y2, D const& z2, S const& x3, L const& y3, Z const& z3)
		{
...
#pragma region BINARY_ARITHMETHIC_OPERATORS
	...
	template<typename T>
	matrix<2, 3, T> operator*(matrix<R, C, T> const& m1, matrix<2, 3, T> const& m2)
	{
		return matrix<2, 3, T>(
	...
	template<typename T>
	matrix<4, 3, T> operator*(matrix<R, C, T> const& m1, matrix<4, 3, T> const& m2)
	{
		return matrix<4, 3, T>(
			m1[0][0] * m2[0][0] + m1[1][0] * m2[0][1] + m1[2][0] * m2[0][2],
			m1[0][1] * m2[0][0] + m1[1][1] * m2[0][1] + m1[2][1] * m2[0][2],
